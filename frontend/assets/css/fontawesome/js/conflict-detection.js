...
;(function (global, factory) {
    ...
    if (noConflictsCount > 0) {
      ...
      for (const _key2 in nodesTested.noConflict) {
        ...
        _data[_key2] = {
          ...
          'innerText excerpt':
            _item.textContent && _item.textContent !== ''
              ? _item.textContent.slice(0, 200) + '...'
              : '(empty)'
        }
      }
    ...
    if (timeOutCount > 0) {
      ...
      for (const _key3 in timedOutTests) {
        ...
        _data2[_key3] = {
          ...
          'innerText excerpt':
            _item2.textContent && _item2.textContent !== ''
              ? _item2.textContent.slice(0, 200) + '...'
              : '(empty)'
        }
      }
  ...
  function detectWebfontConflicts () {
    ...
    for (let _i = 0; _i < styleTags.length; _i++) {
      ...
      styleUnderTest.textContent = styleTags[_i].textContent
  ...
  function detectSvgConflicts (currentScript) {
    ...
    const _loop = function _loop (scriptIdx) {
      ...
      if (scripts[scriptIdx].textContent !== '') {
        scriptUnderTest.textContent = scripts[scriptIdx].textContent
      }
            ...
            parent.postMessage(
              {
                ...
                technology: 'js',
                src: scriptNode.src,
                innerText: scriptNode.textContent,
