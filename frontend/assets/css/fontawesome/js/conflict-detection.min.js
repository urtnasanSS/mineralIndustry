...
(t = function (e) {
  ...
  const b = 'fa-kits-node-under-test'
  const w = 'data-md5'
      ...
      for (
        var c = Array.from(u.scripts).filter(function (e) {
          ...
          e = function (e) {
            ...
            c[e].textContent !== '' && (n.textContent = c[e].textContent),
            (n.async = !0)
  ...
  const F = l.FontAwesomeDetection || {}
  const O = a(
    {},
    {
      report (e) {
