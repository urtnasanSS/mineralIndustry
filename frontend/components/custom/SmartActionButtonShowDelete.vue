    ...
    <el-row class="panel-group" style="width: 100%; padding:10px 10px 8px 10px;">
      ...
      >
        ...
        >
          <el-button
            v-if="
              (routerActions.includes('view') ||
                routerActions.includes('02')) &&
                (config.excludeButtons === undefined ||
                (!config.excludeButtons.includes('view') &&
                !config.excludeButtons.includes('02')))
            "
        ...
        <el-tooltip
          v-if="
            config.includeButtons !== undefined &&
              config.includeButtons.includes('print')
          "
          key="print"
          effect="light"
          :content="'Хэвлэх'"
        ...
        >
          <el-button
            ...
            @click="handlePrint"
          >
            <i v-if="printLoading" class="el-icon-loading" style="font-size:20px; color:#8E8E93;" />
            <i v-else style="font-size:20px; color:#8E8E93;" class="fa fa-print" />
          </el-button>
        </el-tooltip>
        <el-tooltip
          v-if="
            routerActions.includes('remove') &&
              (config.excludeButtons === undefined ||
          ...
          <el-button
            v-if="
              routerActions.includes('delete') &&
                ...
                !config.excludeButtons.includes('delete'))
            "
            style="padding:4px 6px; margin-left:0px; margin-right:15px;"
            plain
            @click="handleDelete"
          >
        ...
        <el-dropdown
          v-if="
            routerActions.includes('download') &&
        ...
        <!-- <el-dropdown v-if="config.otherButtons && config.otherButtons.length > 0" trigger="click">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item
              ...
              v-if="!button.hidden && routerActions.includes(button.code)"
              :key="button.code"
            >
              <span
