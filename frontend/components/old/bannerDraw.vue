        ...
        <div class="contentDrawer">
          ...
          <div class="main">
            ...
            >
              ...
              <el-form-item :label="'Баннерийн төрөл'" prop="bannerTypeId">
                <label v-if="dialogStatus=='view' && temp.bannerTypeIds">{{ temp.bannerTypeIds.name }}</label>
                <el-select
                  v-else
                  v-model="temp.bannerTypeId"
                  clearable
                  size="mini"
                  filterable
                  value-key="id"
                >
                  <el-option v-for="listItem in bannerTypeList" :key="listItem.id" :label="listItem.name" :value="listItem.id" />
                </el-select>
              </el-form-item>
...
<script>
import BannerServices from '../../frontend/services/BannerServices'
import BannerTypeServices from '../../frontend/services/BannerTypeServices'
