      ...
      <div class="drawer__content">
        ...
        >
          ...
          <el-form-item :label="'Код'" prop="code">
            ...
            <el-input v-else v-model="temp.code" size="mini" />
          </el-form-item>
        </el-form>
      </div>
...
import SideMenuServices from '../../services/SideMenuServices'
...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      SideMenuServices.index(this.listQuery)
        .then((response) => {
    ...
    handleDelete () {
      ...
      this.$confirm('Устгахдаа итгэлтэй байна уу', 'Анхааруулга', {
        ...
        .then(() => {
          SideMenuServices.manyDelete(this.selectedTemps)
            .then((response) => {
              this.$notify({
                title: 'Амжилттай',
                message: 'Устгагдлаа',
    ...
    createData () {
      if (this.validateDataForm()) {
        ...
        SideMenuServices.post(this.temp).then((response) => {
    ...
    updateData () {
      if (this.validateDataForm()) {
        this.fullscreenLoading = true
        removeAtts(this.temp)
        SideMenuServices.put(this.temp)
          .then((response) => {
    ...
    validateDataForm () {
      ...
      this.$refs.dataForm.validate((valid, fields) => {
        if (!valid) {
          validateShowMessage(fields, this, 'SideMenu')
          isValidate = false
        }
      })
      return isValidate
