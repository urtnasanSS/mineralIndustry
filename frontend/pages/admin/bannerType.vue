...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      BannerTypeServices.index(this.listQuery)
        .then((response) => {
    ...
    handleDelete () {
      ...
      this.$confirm('Устгахдаа итгэлтэй байна уу', 'Анхааруулга', {
        ...
        .then(() => {
          BannerTypeServices.manyDelete(this.selectedTemps)
            .then((response) => {
              this.$notify({
                title: 'Амжилттай',
                message: 'Устгагдлаа',
    ...
    createData () {
      if (this.validateDataForm()) {
        ...
        BannerTypeServices.post(this.temp)
          .then((response) => {
    ...
    updateData () {
      if (this.validateDataForm()) {
        ...
        removeAtts(this.temp)
        // console.log(this.temp, 'this.temp')
        BannerTypeServices.put(this.temp)
          .then((response) => {
