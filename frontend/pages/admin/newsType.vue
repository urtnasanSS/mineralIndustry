...
import NewsTypeServices from '../../services/NewsTypeServices'
...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      NewsTypeServices.index(this.listQuery)
        .then((response) => {
    ...
    handleDelete () {
      ...
      this.$confirm('Устгахдаа итгэлтэй байна уу', 'Анхааруулга', {
        ...
        .then(() => {
          NewsTypeServices.manyDelete(this.selectedTemps)
            .then((response) => {
              this.$notify({
                title: 'Амжилттай',
                message: 'Устгагдлаа',
    ...
    createData () {
      if (this.validateDataForm()) {
        ...
        NewsTypeServices.post(this.temp)
          .then((response) => {
    ...
    updateData () {
      if (this.validateDataForm()) {
        ...
        removeAtts(this.temp)
        // console.log(this.temp, 'this.temp')
        NewsTypeServices.put(this.temp)
          .then((response) => {
